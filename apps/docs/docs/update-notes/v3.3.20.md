...
This release introduces project-level custom modes and updates to Explain mode.
...
- **Explain Mode Update:** Explain mode is now focused purely on chat interactions and no longer supports editing Markdown files.
