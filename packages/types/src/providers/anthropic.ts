...
export const anthropicModels = {
	"claude-sonnet-5": {
		...
		description:
			"Claude Sonnet 5 is Anthropic's latest high-performance model with always-on adaptive thinking, 1M context, 128K max output. Introductory pricing through August 31, 2026 ($2/$10); standard pricing $3/$15 thereafter.",
	},
	"claude-fable-5": {
		maxTokens: 128_000,
		contextWindow: 1_000_000,
		...
		supportsTemperature: false,
		description:
			"Claude Fable 5 is Anthropic's most capable widely released model, with always-on adaptive thinking for demanding reasoning and long-horizon agentic work.",
	},
	"claude-opus-4-8": {
		maxTokens: 128_000,
		contextWindow: 1_000_000,
